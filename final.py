...
while running:  # The game will be continuously updated.
    ...
    if game_active:
        ...
        walking_sur_1 = pygame.draw.line(screen, (255,0,0), (0,810), (480,810), 1)
        walking_sur_2 = pygame.draw.line(screen, (255,0,0), (550,710), (850,710), 1)
        walking_sur_3 = pygame.draw.line(screen, (255,0,0), (1000,730), (750,730), 1)
        walking_sur_4 = pygame.draw.line(screen, (255,0,0), (1300,610), (1950,610), 1)
